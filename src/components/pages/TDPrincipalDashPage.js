...
class TDPrincipalDashPage extends React.Component {
  ...
  updateProjectData = (projectName) => {
    ...
    if (projectName === 'neurasmus') {
      fetch("http://" + TD_TOOLBOX_ENDPOINT + "/principalSummary/search?projectID=Neurasmus&version=8")
        .then(resp => resp.json())
        .then(resp => {
          this.setState({
            isLoading: true,
      ...
      fetch("http://" + TD_TOOLBOX_ENDPOINT + "/principalIndicators/search?projectID=Neurasmus&version=8")
        .then(resp => resp.json())
        .then(resp => {
          this.setState({
            isLoading: false,
      ...
      fetch("http://" + TD_TOOLBOX_ENDPOINT + "/principalSummary/search?projectID=Holisun%20Arassistance&version=4")
        .then(resp => resp.json())
        .then(resp => {
          this.setState({
            isLoading: true,
      ...
      fetch("http://" + TD_TOOLBOX_ENDPOINT + "/principalIndicators/search?projectID=Holisun%20Arassistance&version=4")
        .then(resp => resp.json())
        .then(resp => {
          this.setState({
            isLoading: false,
      ...
      fetch("http://" + TD_TOOLBOX_ENDPOINT + "/principalSummary/search?projectID=Airbus&version=2")
        .then(resp => resp.json())
        .then(resp => {
          this.setState({
            isLoading: true,
      ...
      fetch("http://" + TD_TOOLBOX_ENDPOINT + "/principalIndicators/search?projectID=Airbus&version=2")
        .then(resp => resp.json())
        .then(resp => {
          this.setState({
            isLoading: false,
