...
class TDInterestDashPage extends React.Component {
 ...
 // Update project
	updateProjectData = (projectName) => {
		...
		{
			fetch("http://195.251.210.147:7070/interestSummary/search?projectID=Neurasmus&version=8&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: false,
      ...
      fetch("http://195.251.210.147:7070/interestIndicators/search?projectID=Neurasmus&version=8&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/lineChartInterestTD/search?projectID=Neurasmus&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/lineChartPrincipalTD/search?projectID=Neurasmus&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/lineChartBreakingPointTD/search?projectID=Neurasmus&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/cumulativeInterestLineChart/search?projectID=Neurasmus&language=c")
			.then(resp => resp.json())
			.then(resp => {
				this.setState({
					isLoading: false,
    ...
    {
      fetch("http://195.251.210.147:7070/interestSummary/search?projectID=Holisun%20Arassistance&version=4&language=java")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: false,
      ...
      fetch("http://195.251.210.147:7070/interestIndicators/search?projectID=Holisun%20Arassistance&version=4&language=java")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/lineChartInterestTD/search?projectID=Holisun%20Arassistance&language=java")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/lineChartPrincipalTD/search?projectID=Holisun%20Arassistance&language=java")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/lineChartBreakingPointTD/search?projectID=Holisun%20Arassistance&language=java")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/cumulativeInterestLineChart/search?projectID=Holisun%20Arassistance&language=java")
			.then(resp => resp.json())
			.then(resp => {
				this.setState({
					isLoading: false,
	...
	fetch("http://195.251.210.147:7070/interestSummary/search?projectID=Airbus&version=2&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: false,
      ...
      fetch("http://195.251.210.147:7070/interestIndicators/search?projectID=Airbus&version=2&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/lineChartInterestTD/search?projectID=Airbus&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/lineChartPrincipalTD/search?projectID=Airbus&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/lineChartBreakingPointTD/search?projectID=Airbus&language=c")
      .then(resp => resp.json())
      .then(resp => {
        this.setState({
          isLoading: true,
      ...
      fetch("http://195.251.210.147:7070/cumulativeInterestLineChart/search?projectID=Airbus&language=c")
			.then(resp => resp.json())
			.then(resp => {
				this.setState({
					isLoading: false,
